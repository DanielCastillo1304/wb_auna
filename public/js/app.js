...
window.$ = window.jQuery = jquery__WEBPACK_IMPORTED_MODULE_0__["default"];
__webpack_require__(/*! ./required_temp */ "./resources/js/required_temp.js");
...
$(document).ready(function () {
  ...
  $(".toggle-section").on("click", function (e) {
    ...
    var $btn = $(this);
    var $section = $($btn.attr("href"));
    var isOpen = $section.hasClass("open");

    // Cerrar otros (acordeón)
    $(".content-section.open").not($section).each(function () {
      var $s = $(this);
      var $p = $("a[href=\"#".concat(this.id, "\"]"));
  ...
  function openSection($section, $btn) {
    var height = $section.css({
      display: "block",
      height: "auto",
      opacity: 0
    }).outerHeight();
    $section.height(0).addClass("open").stop(true).animate({
      height: height,
      opacity: 1
    }, {
      duration: 200,
...
window.showError = function (msg, duration) {
  return AlertService.show("error", msg, duration);
};
window.showWarning = function (msg, duration) {
  return AlertService.show("warning", msg, duration);
};
window.showWaiting = function (msg) {
  return AlertService.show("waiting", msg, 0);
};
