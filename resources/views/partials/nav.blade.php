<nav class="navbar flex justify-between items-center bg-white h-[60px] px-4 md:px-8 sticky top-0 z-[30]"
    ...
    <div class="flex items-center gap-3">
        ...
        {{-- Breadcrumb dinámico si lo necesitas --}}
        {{-- <span class="text-xs text-slate-400 font-medium hidden md:block">Dashboard</span> --}}
    </div>
        ...
        <div class="relative group">
            ...
            <div class="box-user flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg cursor-pointer transition-all hover:bg-slate-50"
                ...
                <div class="hidden md:block text-left">
                    ...
                    <p class="text-[10px] font-medium text-slate-400 mt-0.5 leading-none">
                        Usuario
                    </p>
                </div>
            ...
            <div class="box-user-collapse absolute top-full right-0 mt-1.5 w-[220px] hidden z-50 bg-white rounded-xl overflow-hidden"
                ...
                <div class="p-1.5">
                    <a href="{{ route('logout') }}"
                        class="flex items-center gap-2.5 px-3 py-2 rounded-lg transition-all text-red-500 hover:bg-red-50 group/out">
                        <span class="material-symbols-outlined text-[18px] group-hover/out:translate-x-0.5 transition-transform">
                            logout
                        </span>
