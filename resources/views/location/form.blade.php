...
@section('content')
    <div class="min-h-screen" style="background: #f4f6f8;">
        ...
        <div class="px-6 lg:px-10 py-6 max-w-3xl">
            ...
            <form id="mainForm" enctype="multipart/form-data" novalidate>
                @csrf
                <input type="hidden" id="recordId" value="{{ $location->codlocation ?? '' }}">
                        ...
                        <div class="flex items-center gap-2 w-full sm:w-auto">
                            ...
                            <button type="submit" id="btnSubmit"
                                ...
                                <span id="btnSubmitText">
                                    {{ isset($location) ? 'Actualizar' : 'Guardar' }}
                                </span>
    ...
    @push('scripts')
        <script>
            ...
            const recordId = "{{ $location->codlocation ?? '' }}";
        </script>
