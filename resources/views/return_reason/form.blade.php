...
@section('content')
    <div class="min-h-screen" style="background: #f4f6f8;">
        ...
        <div class="bg-white px-6 lg:px-10 py-4 flex items-center gap-4" style="border-bottom: 1px solid #e8edf2;">
            ...
            <span class="ml-1 px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wider"
                ...
                {{ isset($return_reason) ? 'Editando' : 'Nuevo' }}
            </span>
        </div>
        ...
        <div class="px-6 lg:px-10 py-6 max-w-3xl">
            ...
            <form id="mainForm" enctype="multipart/form-data" novalidate>
                @csrf
                <input type="hidden" id="recordId" value="{{ $return_reason->codreturn_reason ?? '' }}">
                ...
                <div class="bg-white rounded-lg overflow-hidden"
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" id="description" name="description" required placeholder="Ej: Equipo defectuoso"
                                value="{{ $return_reason->description ?? '' }}"
                        ...
                        <div class="flex items-center gap-2 w-full sm:w-auto">
                            ...
                            <button type="submit" id="btnSubmit"
                                ...
                                <span id="btnSubmitText">
                                    {{ isset($return_reason) ? 'Actualizar' : 'Guardar' }}
                                </span>
    ...
    @push('scripts')
        <script>
            ...
            const recordId = "{{ $return_reason->codreturn_reason ?? '' }}";
        </script>
